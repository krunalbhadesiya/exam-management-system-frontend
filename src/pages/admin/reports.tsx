...
import { getAllReports } from "@/api/ReportData"; // Import the function
...
export default function AdminReports() {
    ...
    return (
        <div className="w-full ">
            <AdminHeader pageName="Exam Report" />
            <AdminDock />
                            ...
                            <TableBody>
                                {filteredExamResults.map((result) => (
                                    <TableRow key={result.id}>
                                        ...
                                        <TableCell>
                                            <div
                                                className={`px-2 py-1 rounded-full text-xs text-center font-medium ${result.result === "pass" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                                                    }`}
                                            >
                                                {result.result}
                                            </div>
                                        </TableCell>
                                        <TableCell className="text-center">{result.examDate}</TableCell>
                                    </TableRow>
                                ))}
                            </TableBody>
                        </Table>
